            ...
            <main class="main">
                <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post-additional-info">
                                ...
                                <span class="category">
                                    ...
                                    <a href="{{route('categoryPosts', ['id' => $post->category->id])}}">{{ $post->category->category_name }}</a>
                                </span>
                                ...
                                <div class="widget w-tags">
                                    <div class="tags-wrap">
                                        @foreach ($post->tags as $tag)
                                            <a href="{{route('tagsPosts', ['id' => $tag->id])}}" class="w-tags-item">{{$tag->tag_name}}</a>
                                        @endforeach
                                    </div>
                                </div>
                    ...
                    <div class="pagination-arrow">
                        ...
                        @if ($prev)
                            <a href="{{route('singlePost', ['slug' => $prev->slug])}}" class="btn-next-wrap">
                        ...
                        @if ($next)
                            <a href="{{route('singlePost', ['slug' => $next->slug])}}" class="btn-prev-wrap">
                                <svg class="btn-prev">
